<div class="modal fade" id="deletemember<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="delete_faculty.php?userID=<?php echo $row['id']; ?>" class="btn btn-danger"><i class="icon-check icon-large"></i>&nbsp; Yes</a>
                </form>
            </div>
        </div>
        <!-- /.modal-content -->
